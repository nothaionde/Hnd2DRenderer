...
/**
 * A layer that handles the rendering of the ImGui interface.
 */
public class ImGuiLayer extends Layer {
    ...
    /**
     * Sets the color theme of the ImGui interface.
     *
    ...
    /**
     * Begins the ImGui interface frame.
     */
    public void begin() {
    ...
    /**
     * Ends the ImGui interface frame and renders it to the screen.
     */
    public void end() {
    ...
    /**
     * An enum representing the two available color themes for the ImGui interface.
     */
    public enum Theme {
        DARK,
        LIGHT
